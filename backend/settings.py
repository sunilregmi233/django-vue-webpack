...
SECRET_KEY = ')p_!43aket!!z$s4)l&n!6i2&k8^z2obtpl!+!g+^m+*v&52!8'
...
#I sometimes wrap this in a if DEBUG: conditional and we know we’re moving to production when DEBUG is false in settings.py.
